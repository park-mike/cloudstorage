...
class CloudStorageApplicationTests {
     ...
     **/
    private void doMockSignUp(String firstName, String lastName, String TEST_USENAME, String TEST_PASSWORD) {
        ...
        inputUsername.click();
        inputUsername.sendKeys(TEST_USENAME);
		...
		*/
        Assertions.assertTrue(webDriver.findElement(By.id("success-msg")).getText().contains("You successfully signed up!"));
    }
     ...
     * Helper method for Udacity-supplied sanity checks.
     **/
    private void doLogIn(String TEST_USERNAME, String TEST_PASSWORD) {
